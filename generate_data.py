...
if __name__ == "__main__":
    ...
    parser.add_argument('--start_temp', type=float, default=10.0, help="probability of uniform delimiters")
    parser.add_argument('--transition_temp', type=float, default=0.1, help="probability of uniform delimiters")
    ...
    parser.add_argument('--n_values', type=int, default=5, help="number of hidden states")
    parser.add_argument('--n_slots', type=int, default=5, help="number of hidden states")
    parser.add_argument('--value_identity_coeff', type=float, default=0.8, help="mixing coefficient for identity matrix on value transmat")
    parser.add_argument('--random_data', action='store_true', help="whether to generate random data")
    parser.add_argument('--no_prior_slots', action='store_true', help="only one slot transmat")
    parser.add_argument('--prior_values', action='store_true', help="use prior on values")
    parser.add_argument('--n_train_samples', type=int, default=1000, help="number of training documents")
    parser.add_argument('--prompt_length', type=int, default=None, help="length of x sequence in prompt examples")
    parser.add_argument('--n_hmms', type=int, default=100, help="number of total hmms")
